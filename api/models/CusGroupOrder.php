 ...
 * @property int $is_group_success 是否成团
 ...
 */
class CusGroupOrder extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['store_id', 'pay_way','participants_num', 'group_commodity_id','is_group_commander', 'is_group_success', 'group_id', 'pay_time', 'pay_record_no_expire', 'status', 'line_sequence', 'driver_id', 'delivery_time_id', 'is_send_to_home', 'user_id', 'close_time', 'close_type', 'coupon_id', 'is_audit', 'audit_time', 'audit_user_id', 'source', 'return_num', 'create_time'], 'integer'],
            [['order_no', 'delivery_date', 'delivery_time_detail', 'user_name', 'create_time'], 'required'],
            [['price', 'pay_price', 'address_lng', 'address_lat', 'freight_price', 'reduction_price', 'return_price'], 'number'],
            [['is_pay'], 'string'],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'group_commodity_id' => 'Group Commodity ID',
    ...
    {
        return $this->hasMany(CusGroupOrderDetail::className(), ['order_id' => 'id']);
    }
}
