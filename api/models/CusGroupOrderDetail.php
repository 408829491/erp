 ...
 */
class CusGroupOrderDetail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bn_cus_group_order_detail';
    }
    ...
    {
        return [
            [['store_id', 'order_id', 'shop_cart_id', 'source_type_id', 'commodity_id', 'type_first_tier_id', 'type_id', 'num', 'is_basics_unit', 'base_self_ratio', 'is_delete', 'refund_num', 'is_purchase_num', 'is_seckill', 'is_sorted', 'actual_num', 'cart_id', 'update_at', 'create_time', 'stock_position', 'sort_id', 'sort_time'], 'integer'],
            [['unit'], 'required'],
            [['notice'], 'string'],
            [['price', 'total_price'], 'number'],
            [['commodity_name'], 'string', 'max' => 100],
            [['parent_type_name', 'type_name', 'sort_name'], 'string', 'max' => 50],
            [['pic', 'basic_unit', 'remark'], 'string', 'max' => 255],
            [['unit'], 'string', 'max' => 20],
        ];
    }
