...
/**
 * This is the model class for table "cus_store".
 *
 * @property string $id
...
class CusStore extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['limit_delivery_meter', 'type'], 'integer'],
            [['create_datetime', 'modify_datetime'], 'safe'],
            [['name', 'address', 'relation_people', 'relation_phone'], 'string', 'max' => 255],
            [['relation_face_url', 'info'], 'string', 'max' => 999],
        ];
    }
