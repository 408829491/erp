...
/**
 * This is the model class for table "bn_cus_group_commodity".
 *
 * @property int $id ID
 * @property int $cus_commodity_id 商品ID
 * @property int $cus_group_id 团购表ID
 ...
 */
class CusGroupCommodity extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['cus_commodity_id', 'cus_group_id', 'store_id', 'type_first_tier_id', 'type_id', 'limit_buy', 'success_num', 'is_online', 'sell_num', 'sequence', 'provider_id', 'agent_id', 'parent_id', 'channel_type', 'is_time_price', 'is_sell_stock', 'unit_change_disabled'], 'integer'],
