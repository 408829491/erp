 ...
 */
class FinanceAccountSettlePurchase extends \yii\db\ActiveRecord
{
    public $list = [];
    ...
    {
        return 'bn_finance_account_settle_purchase';
    }
    ...
    {
        return [
            [['settle_no', 'create_time', 'list'], 'required'],
            [['price', 'actual_price', 'reduction_price'], 'number'],
            [['pay_way', 'create_time','agent_id','purchase_type'], 'integer'],
            [['settle_no', 'agent_name', 'refer_no', 'create_user', 'pay_user'], 'string', 'max' => 50],
            [['pay_way_text'], 'string', 'max' => 20],
    ...
    {
        return $this->hasOne(FinanceAccountSettlePurchaseDetail::className(), ['settle_id' => 'id']);
    }
}
