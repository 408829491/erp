 ...
 */
class PurchaseAuditDetail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'bn_purchase_audit_detail';
    }
    ...
    {
        return [
            [['type_first_tier_id', 'type_id', 'commodity_id', 'purchase_num', 'return_num', 'status', 'unreceive', 'create_time'], 'integer'],
            [['last_in_price', 'inquiry_price', 'price', 'diff_num', 'purchase_price', 'diff_price', 'diff_total_price', 'purchase_total_price', 'total_price', 'num'], 'number'],
