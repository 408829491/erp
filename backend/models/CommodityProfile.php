 ...
 * @property string $in_price 进价
 * @property string $price 价格
 * @property string $stock_num 库存
...
class CommodityProfile extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['commodity_id', 'is_basics_unit', 'is_sell', 'is_delete', 'source_from','is_setting_formula'], 'integer'],
            [['name'], 'required'],
            [['price', 'base_self_ratio','in_price','stock_num','stock_limit_up_num','stock_limit_down_num'], 'number'],
            [['name'], 'string', 'max' => 50],
            [['desc'], 'string', 'max' => 999],
        ];
    }
