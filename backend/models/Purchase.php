...
class Purchase extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['purchase_no', 'plan_date', 'status','create_time'], 'required'],
            [['storage_id', 'purchase_type', 'source', 'agent_id', 'provider_id', 'procured_num', 'purchase_num', 'sort_type', 'status', 'is_delete', 'create_time','is_settlement','settlement_time','is_audit','audit_time'], 'integer'],
            ...
            [['share_url', 'remark','order_ids'], 'string', 'max' => 255],
        ];
    }
