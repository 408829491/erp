...
class Order extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['price', 'pay_price', 'freight_price', 'reduction_price', 'return_price', 'quantity', 'total_profit','actual_price'], 'number'],
            [['pay_way', 'pay_time', 'pay_record_no_expire', 'status', 'line_sequence', 'driver_id', 'delivery_time_id', 'user_id', 'close_time', 'close_type', 'audit_time', 'audit_user_id', 'source', 'return_num', 'create_time','c_type','salesman_id'], 'integer'],
            [['is_pay', 'nick_name'], 'string'],
            [['order_no', 'status_text', 'line_name'], 'string', 'max' => 100],
            [['pay_way_text', 'pay_record_no', 'is_pay_text', 'driver_mobile', 'driver_name', 'delivery_date', 'delivery_time_detail', 'receive_name', 'receive_tel', 'user_name', 'coupon_code', 'source_txt','salesman_name'], 'string', 'max' => 50],
