 ...
 * @property double $actual_num 实际分拣数量
...
class OrderDetail extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['order_id', 'commodity_id', 'type_first_tier_id', 'type_id', 'num', 'channel_type', 'is_delete', 'refund_num', 'is_purchase_num', 'is_seckill', 'is_sorted', 'update_at', 'create_time', 'stock_position', 'sort_id', 'is_basics_unit', 'sort_time', 'provider_id', 'agent_id','c_type'], 'integer'],
            [['notice'], 'string'],
            [['in_price', 'price', 'total_profit', 'total_price', 'actual_num', 'base_self_ratio','total_actual_price'], 'number'],
