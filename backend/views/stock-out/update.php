        ...
        layui.config({
            ...
            table.render({
                ...
                ,cols: [[ //标题栏
                    ...
                    ,{field: 'num', title: '出库数',width: 120,templet: '#test-table-countTpl', unresize: true,edit: 'text',event: 'setCount'}
            ...
            var action = {
                ...
                audit: function () {
                    layer.confirm('请确认是否审核该出库单', {icon: 3, title: '提示'}, function (index) {
                        admin.req({
                            type: "post"
                            , url: '/admin/stock-out/audit?id=<?=$id?>'
                            , dataType: "json"
                            , cache: false
                            , done: function (d) {
                                if(d.code === '200'){
