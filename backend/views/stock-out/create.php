    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="remark" id="remark" placeholder="输入备注" autocomplete="off" class="layui-input" style="width:850px">
                </div>
            </div>
        </div>
    </div>
    ...
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[ //标题栏
                ...
                ,{field: 'num', title: '入库数',width: 120,templet: '#test-table-countTpl', unresize: true,edit: 'text',event: 'setCount'}
