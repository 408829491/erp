                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="store_id_name" disabled>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="operator" id="operator" autocomplete="off" value="<?= $operator ?>" class="layui-input layui-disabled" style="width:210px" lay-verify="required" >
                        </div>
                    </div>
                </div>
            </div>
                ...
                layui.config({
                    ...
                    table.render({
                        ...
                        ,cols: [[ //标题栏
                            ...
                            ,{field: 'num', title: '出库数量',width: 120, unresize: true,}
