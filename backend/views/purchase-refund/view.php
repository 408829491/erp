<div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 15px">
    <div class="layui-card">
        <div class="layui-card-header">基本信息
            <div style="float:right" class="layui-hide">
                <button class="layui-btn layui-btn-xs layui-btn-normal" id="copy-order" data-type="copyOrder">复制已有订单
                </button>
            </div>
        </div>
            ...
            <div class="layui-card-header layuiadmin-card-header-auto">
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-inline" id="purchase_type"><?= $refund_no ?></div>
                    </div>
                    <div class="layui-inline">
                    ...
                    <div class="layui-inline">
                        <label class="layui-form-label" style="width: 120px;">源采购单号：</label>
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-inline" id="purchase_type"><?= $author ?></div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label" style="width: 200px;">单据日期</label>
                        <div class="layui-inline" id="purchase_no"><?= $create_time ?></div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label" style="width: 200px;">退货金额</label>
                        <div class="layui-inline" id="purchase_no"><?= $price ?></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="remark" id="remark" placeholder="请输入备注" autocomplete="off"
                                   class="layui-input" style="width:850px" value="<?= $remark ?>">
                            <input type="hidden" id="id" name="id"
                                   value="<?php if (Yii::$app->request->get('type') != 'copy') {
                                       echo $id;
                                   } else echo 0; ?>">
                        </div>
                    </div>
            ...
            <script type="text/html" id="purchase_priceTpl">
                <input type="text" name="purchase_price" placeholder="" autocomplete="off" class="layui-input order_c"
                       id="purchase_price" lay-filter="purchase_price" style="height: 28px"
                       value="{{d.purchase_price}}">
            </script>
            <script type="text/html" id="purchase_numTpl">
                <input type="text" name="purchase_num" placeholder="" autocomplete="off" class="layui-input order_c"
                       id="purchase_num" lay-filter="purchase_num" style="height: 28px" value="{{d.purchase_num}}">
            </script>
            <script type="text/html" id="total_priceTpl">
                <input type="text" name="total_price" placeholder="" autocomplete="off" class="layui-input order_c"
                       id="purchase_total_price" lay-filter="purchase_total_price" style="height: 28px"
                       value="{{d.total_price}}">
            </script>
            <script type="text/html" id="test-table-commentTpl">
                <input type="text" name="remark" placeholder="" autocomplete="off" class="layui-input"
                       style="height: 28px" value="{{d.remark}}">
            </script>
