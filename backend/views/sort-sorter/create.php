        ...
        <div class="layui-card-body">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="nickname" lay-verify="required"  placeholder="请填写姓名" value="" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="username" lay-verify="required"  placeholder="请设置登录账户" value="" autocomplete="off" class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="device_addr" placeholder="请设置设备地址" value="" autocomplete="off" class="layui-input">
                </div>
                <label class="layui-form-label">设备密码</label>
                <div class="layui-input-inline">
                    <input name="device_pwd" type="text"  placeholder="请设置设备密码" autocomplete="off" class="layui-input" autocomplete="off">
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="print_num"  placeholder="请设置打印编号" value="" autocomplete="off" class="layui-input">
                </div>
                <label class="layui-form-label">打印密码</label>
                <div class="layui-input-inline">
                    <input name="print_pwd" type="text"  placeholder="请设置打印密码" autocomplete="off" class="layui-input" autocomplete="off">
                </div>
            </div>
...
<script>
    layui.config({
        ...
        $.get({
            type: "post"
            , url: '/admin/sort-sorter/get-cate-list'
            , dataType:'json'
            , success: function (e) {
