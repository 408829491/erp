    ...
    <script>
        layui.config({
            ...
            table.render({
                elem: '#list'
                , url: '/admin/store-room/out-of-stock-by-order-data'
                ...
                , cols: [[
                    ...
                    , {field: 'delivery_time_detail', title: '收货时间'}
            ...
            table.on('tool(list)', function (obj) {
                ...
                if (obj.event === 'showTable') {
                    ...
                    table.render({
                        elem: '#' + tableId
                        , id: 'table' + tableId
                        , url: '/admin/store-room/out-of-stock-by-order-data-view?orderId=' + data.id
                        , title: '发货出库详情'
                        , cols: [[
                            {field: 'commodity_id', title: '商品编码', width: 235, sort: true}
                            , {field: 'commodity_name', title: '商品名称', width: 230}
                    ...
                    layer.confirm('是否确认发货？', {icon: 3, title:'提示'}, function (index) {
                        admin.req({
                            type: "get"
                            , url: '/admin/store-room/send-out-by-order-id'
                            , dataType: "json"
                            , cache: false
                            , data: {
                                orderId: data.id
