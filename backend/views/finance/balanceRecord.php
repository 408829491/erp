        ...
        <script>
            layui.config({
                ...
                table.render({
                    elem: '#subList'
                    ,cols: [[ //标题栏
                        {field: 'recharge_no', title: '流水号', unresize: true,width:200}
                        ,{field: 'refer_no', title: '关联单号', unresize: true,width:200}
