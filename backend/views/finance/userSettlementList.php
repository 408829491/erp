<div class="layui-fluid">
        ...
        <div class="layui-card">
            <div class="layui-form layui-card-header layuiadmin-card-header-auto" lay-filter="layui-form">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            <input type="text" name="delivery_date" class="layui-input" id="test-laydate-range-date" placeholder="请选择创建日期">
                        </div>
                    </div>
    ...
    <script>
        layui.config({
            ...
            table.render({
                elem: '#order-list'
                ,url: '/admin/finance/get-settle-list'
                ,toolbar: '#order-list-toolbarDemo'
                ,title: '用户数据表'
                ,cols: [[
                    {field:'id', title:'ID', width:80, fixed: 'left', unresize: true, sort: true}
                    ,{field:'settle_no', title:'结算单号', width:235}
                    ,{field:'user_name', title:'客户名称',sort: true}
                    ,{field:'price', title:'单据金额', sort: true}
                ...
                switch(obj.event){
                    case 'detail':
                        var window_detail = layer.open({
                            type: 2,
                            content: '/admin/finance/settlement-detail?id='+ obj.data.id,
                            area: ['800px', '830px'],
                            title:'结算单详情',
                            maxmin: true,
                            btn: ['返回']
