<div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 15px">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="operator" id="operator" autocomplete="off"
                                   ...
                                   class="layui-input layui-disabled" style="width:210px" lay-verify="required">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="layui-card">
        <div class="layui-card-header">出库商品清单</div>
        <div class="layui-card-body">
            <div class="layui-inline">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name='count' class="layui-input" id="count" placeholder="" style="width: 60px;"
                           value="1">
                </div>

                <div class="layui-input-inline">
                    <button class="layui-btn layui-input-inline" id="product-add-list" data-type="addProductSingle">添加
                    </button>
                </div>
            </div>
        ...
        <div class="layui-card">
            <div class="layui-card-body">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="remark" id="remark" placeholder="输入订单备注" autocomplete="off"
    ...
    <script type="text/html" id="test-table-countTpl">
        <input type="text" name="order_count" placeholder="" autocomplete="off" class="layui-input order_c"
               id="order_count" lay-filter="order_count" style="height: 28px" value="{{d.num}}">
    </script>

    <script type="text/html" id="test-table-commentTpl">
        <input type="text" name="remark" placeholder="" autocomplete="off" class="layui-input" style="height: 28px"
               value="{{d.remark}}">
    </script>
    ...
    <script>
        layui.config({
            ...
            var action = {
                ...
                audit: function () {
                    layer.confirm('请确认是否审核该入库单', {icon: 3, title: '提示'}, function (index) {
                        admin.req({
                            type: "post"
                            , url: '/admin/stock-in/audit?id=<?=$id?>'
                            , dataType: "json"
                            , cache: false
                            , done: function (d) {
                                if(d.code === '200'){
