...
<div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 20px 30px 0 0;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="checkbox" name="is_online" lay-skin="switch" lay-text="是|否" <?php if ($model['is_online']) : ?>checked<?php endif; ?>>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="display: flex;width: 350px">
            <input type="text" name="commodity_code" style="width: 300px;" lay-verify="required" placeholder="长度<30,必填" autocomplete="off" value="<?= $model['commodity_code'] ?>" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label"><span style="color: #ff6d6d;margin-right: 5px;">*</span>商品名称</label>
        <div class="layui-input-inline" style="width: 350px;">
            <input type="text" name="name" style="width: 300px;" lay-verify="required" placeholder="长度<30个字,必填,如:白菜" autocomplete="off" value="<?= $model['name'] ?>" class="layui-input">
        </div>
        <label class="layui-form-label">商品别名</label>
        <div class="layui-input-inline" style="width: 350px;">
            <input type="text" name="alias" style="width: 300px;" placeholder="长度<20个字" autocomplete="off" value="<?= $model['alias'] ?>" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">商品品牌</label>
        <div class="layui-input-inline" style="width: 350px;">
            <input type="text" name="brand" style="width: 300px;" placeholder="长度<20个字" autocomplete="off" value="<?= $model['brand'] ?>" class="layui-input">
        </div>
        <label class="layui-form-label">商品产地</label>
        <div class="layui-input-inline" style="width: 350px;">
            <input type="text" name="product_place" style="width: 300px;" placeholder="长度<30个字" autocomplete="off" value="<?= $model['product_place'] ?>" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">助记码</label>
        <div class="layui-input-inline" style="width: 350px;">
            <input type="text" name="pinyin" style="width: 300px;" placeholder="长度<128个字" autocomplete="off" value="<?= $model['pinyin'] ?>" class="layui-input">
        </div>
        <label class="layui-form-label">损耗率</label>
        <div class="layui-input-inline" style="display:flex;width: 350px;align-items: center">
            <input type="text" name="loss_rate" style="width: 300px;" placeholder="长度<30个字" autocomplete="off" value="<?= $model['loss_rate'] ?>" class="layui-input">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 350px">
            <input type="text" name="durability_period" style="width: 300px;" placeholder="输入保质期" autocomplete="off" value="<?= $model['durability_period'] ?>" class="layui-input">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 350px">
            <textarea type="text" name="summary" style="width: 300px;" placeholder="填写描述" autocomplete="off" class="layui-textarea"><?= $model['summary']?></textarea>
        </div>
    </div>
    ...
    <div class="layui-form-item" style="display: flex;flex-direction: column">
        ...
        <div style="display: flex;flex-flow: wrap;padding-left: 20px" id="mainPicture">
            <div style="width:100px;height: 100px;border:1px dashed #ffffff;display: flex;align-items: center;justify-content: center;" id="addMainPicture">
                <i class="layui-icon layui-icon-camera-fill" style="font-size: 30px; color: #000000;"></i>
            </div>
            <?php foreach (explode(':;', $model['pic']) as $item) : ?>
                <div class="image_div">
        ...
        <div style="display: flex;padding-left: 20px">
            <table style="width: 100%;" id="unitTable">
                ...
                <tr class="table_tr">
                            ...
                            <div class="table_td_div_div">
                                <select lay-filter="basicUnit" name="unit_unit">
                                    <?php foreach ($unitList as $item) : ?>
                                        <?php if ($item == $modelSubBasicUnit['name']) : ?>
                    ...
                    <td class="table_td">
                        <textarea name="unit_desc" placeholder="长度<20个字" class="layui-textarea"><?= $modelSubBasicUnit['desc']?></textarea>
                    </td>
                    <td class="table_td">
                        <input name="in_price" placeholder="进货价" class="layui-input" style="width: 100px;" value="<?= $modelSubBasicUnit['in_price']?>">
                    </td>
                    <td class="table_td">
                        <input name="price2" placeholder="市场价" class="layui-input" style="width: 100px;" value="<?= $modelSubBasicUnit['price']?>">
                    </td>
                    <td class="table_td" name="unitPrice">
                        <?php foreach ($modelSubBasicUnit['priceList'] as $item2) : ?>
                            <div class="unit_price_div">
                                <input type="hidden" name="priceType" value="<?= $item2['id']?>">
                                <span class="unit_price_div_text"><?= $item2['name']?></span>
                                <input type="text" name="price" style="width:100px" autocomplete="off" value="<?= $item2['price']?>" class="layui-input">
                            </div>
                        <?php endforeach; ?>
                    </td>
                    <td class="table_td">
                        <input type="checkbox" name="unit_is_sell" lay-skin="switch" <?php if ($modelSubBasicUnit['is_sell'] == 1) : ?>checked<?php endif; ?>>
                    </td>
                </tr>
                <?php foreach ($modelSubUnitLList as $item) : ?>
                    <tr class="table_tr">
                        <td class="table_td">
                           <image src="/admin/imgs/add.png" class="table_operation_add" name="addUnit"></image>
                                ...
                                <div class="table_td_div2_div">
                                    <div class="table_td_div2_div_div">
                                        <select name="unit_unit">
                                            <?php foreach ($unitList as $item1) : ?>
                                                <?php if ($item1 == $item['name']) : ?>
                                    ...
                                    <div>=</div>
                                    <div class="table_td_div2_div_div2"><input type="number" name="unit_base_self_ratio" value="<?= $item['base_self_ratio']?>" class="layui-input"/></div>
                                    <div name="selectedBasicUnit"><?= $modelSubBasicUnit['name']?></div>
                                </div>
                            </div>
                        </td>
                        <td class="table_td">
                            <textarea name="unit_desc" placeholder="长度<20个字" class="layui-textarea"><?= $item['desc']?></textarea>
                        </td>
                        <td class="table_td">
                            <input name="in_price" placeholder="进货价" class="layui-input" style="width: 100px;" value="<?= $item['in_price']?>">
                        </td>
                        <td class="table_td">
                            <input name="price2" placeholder="市场价" class="layui-input" style="width: 100px;" value="<?= $item['price']?>">
                        </td>
                        <td class="table_td" name="unitPrice">
                            <?php foreach ($item['priceList'] as $item2) : ?>
                                <div class="unit_price_div">
                                    <input type="hidden" name="priceType" value="<?= $item2['id']?>">
                                    <span class="unit_price_div_text"><?= $item2['name']?></span>
                                    <input type="text" name="price" style="width:100px" autocomplete="off" value="<?= $item2['price']?>" class="layui-input">
                        ...
                        <td class="table_td">
                            <input type="checkbox" name="unit_is_sell" lay-skin="switch" <?php if ($item['is_sell'] == 1) : ?>checked<?php endif; ?>>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 350px;">
            <input type="text" name="sequence" style="width: 300px;" autocomplete="off" value="<?= $model['sequence'] ?>" class="layui-input">
        </div>
        <div class="layui-input-inline" style="display:flex;width: 350px;align-items: center">
            <input type="radio" name="is_rough" value="Y" title="标品" checked>
            <input type="radio" name="is_rough" value="N" title="非标品" <?php if ($model['is_rough'] == 'N') : ?>checked<?php endif; ?>>
            <input type="checkbox" name="is_time_price" title="是否时价" <?php if ($model['is_time_price'] == 1) : ?>checked<?php endif; ?>>
        </div>
    </div>
    <!--<div class="layui-form-item">
    ...
    layui.config({
        ...
        admin.req({
            ...
            , done: function (res) {
                ...
                for (var i = 0; i < tagList.length; i++ ){
                    var flag = false;
                    tagListData.split(":;").forEach(function (data, index) {
                        if (data == tagList[i]) {
                            flag = true;
                        }
                    });
                    if (flag) {
                        ...
                        $("#tagList").append(
                            '<input type="checkbox" name="tag" title="' + tagList[i] + '" value="' + tagList[i] + '">'
                        )
                    }
                }
                form.render();
            ...
            , done: function (res) {
                ...
                for (var i = 0; i < productCategory.length; i++ ){
                    if (productCategory[i].pid == 0) {
                        if (productCategory[i].id == <?= $model['type_first_tier_id']?>) {
                            productCategoryElement.append('<option selected value="' + productCategory[i].id + '">' + productCategory[i].name + '</option>');
                            for (var j = 0; j < productCategory.length; j++) {
                                if (productCategory[j].pid == productCategory[i].id) {
                                    if (productCategory[j].id == <?= $model['type_id']?>) {
                                        typeIdElement.append('<option selected value="' + productCategory[j].id + '">' + productCategory[j].name + '</option>');
                                    } else {
                                        typeIdElement.append('<option value="' + productCategory[j].id + '">' + productCategory[j].name + '</option>');
                                    }
                                }
                            }
                        } else {
        ...
        $("body").on('click','[name=addUnit]',function () {
            unitTable.append(
                ...
                '                    </td>\n' +
                '                    <td class="table_td">\n' +
                '                        <input name="in_price" placeholder="长度<20个字" class="layui-input" style="width: 100px;" value="0">\n' +
                '                    </td>\n' +
                '                    <td class="table_td">\n' +
                '                        <input name="price2" placeholder="长度<20个字" class="layui-input" style="width: 100px;" value="0">\n' +
                '                    </td>\n' +
                '                    <td class="table_td" name="unitPrice">\n' +
        ...
        admin.req({
            ...
            , done: function (res) {
                ...
                basicUnitText = "<?= $modelSubBasicUnit['name'] ?>";
        ...
        var catIns1 = selectN({
            ...
            ,selected: [<?=$model['channel_type']?><?php if ($model['agent_id'] != 0) : ?> ,<?=$model['agent_id']?><?php endif; ?>]
        });
    })
</script>