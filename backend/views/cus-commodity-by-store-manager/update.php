...
<form class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 350px;">
            <input type="text" name="" style="width: 300px;" placeholder="长度<128个字" autocomplete="off" class="layui-input">
        </div>
        <label class="layui-form-label"><span style="color: #ff6d6d;margin-right: 5px;">*</span>采购类型</label>
        <div class="layui-input-inline" style="display:flex;width: 350px;align-items: center">
            <input type="radio" name="channel_type" value="1" title="供应商送货" checked>
            <input type="radio" name="channel_type" value="0" title="市场自采" <?php if ($model->channel_type == 0) : ?>checked<?php endif; ?>>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div style="display: flex;padding-left: 20px">
            <table style="width: 100%;" id="unitTable">
                ...
                <tr class="table_tr">
                    ...
                    <td class="table_td">
                        <input type="text" name="unit_price" autocomplete="off" value="<?= $modelSubBasicUnit->price ?>" class="layui-input">
                    </td>
                    <td class="table_td">
                ...
                <?php foreach ($modelSubUnitLList as $item) : ?>
                    <tr class="table_tr">
                        ...
                        <td class="table_td">
                            <input type="text" name="unit_price" autocomplete="off" value="<?= $item->price?>" class="layui-input">
                        </td>
                        <td class="table_td">
...
<script>
    layui.config({
        ...
        form.on('submit(layuiadmin-app-form-submit)', function (data) {
            ...
            admin.req({
                type: "post"
                , url: '/admin/cus-commodity-by-store-manager/edit'
                , dataType: "json"
                , cache: false
                , data: field
                , done: function () {
