...
<div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 20px 30px 0 0;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 350px;">
            <input type="text" name="name" style="width: 300px;" lay-verify="required" placeholder="请输入活动名称" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 350px">
            <div style="width: 300px;display: flex;">
                <input type="text" name="date" lay-verify="required" class="layui-input" id="activityTime" readonly>
            </div>
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        <label style="display: flex;margin-left: 20px;align-items: center">团购商品列表<button class="layui-btn layui-btn-sm" id="addSubList" style="margin-left: 15px">新增</button></label>
        <div class="layui-input-inline" style="width: 100%;margin-left: 20px;margin-top: 15px">
            ...
            <script type="text/html" id="successNum">
                <input type="text" name="success_num" class="layui-input" value="2">
            </script>
...
<script>
    layui.config({
        ...
        form.on('submit(layuiadmin-app-form-submit)', function (data) {
            ...
            admin.req({
                type: "post"
                , url: '/admin/cus-group-commodity/save'
                , dataType: "json"
                , cache: false
                , data: field
                , done: function () {
