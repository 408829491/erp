        ...
        <div class="layui-card-body">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="name" lay-verify="required"  placeholder="请填写供应商名称" value="<?=$model->name?>" autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
    </div>
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="contact_name" lay-verify="required"  placeholder="请填写联系人姓名" value="<?=$model->contact_name?>" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span style="color: #ff6d6d;margin-right: 5px;">*</span>联系手机</label>
                <div class="layui-input-block">
                    <input name="mobile" type="text"  placeholder="请填写联系手机" lay-verify="required|phone" autocomplete="off" value="<?=$model->mobile?>" class="layui-input" autocomplete="off">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">电话</label>
                <div class="layui-input-block">
                    <input type="text" name="tel" placeholder="请填写联系人电话号码" value="<?=$model->tel?>" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">详细地址</label>
                <div class="layui-input-block">
                    <input type="text" name="address_detail" placeholder="请填写详细地址" value="<?=$model->address_detail?>" autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
    </div>
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="bank_name"  placeholder="请填写开户名称"  autocomplete="off" class="layui-input" value="<?=$model->bank_name?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">开户银行</label>
                <div class="layui-input-block">
                    <input type="text" name="bank" placeholder="请填写开户银行"  autocomplete="off" class="layui-input" value="<?=$model->bank?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">银行账号</label>
                <div class="layui-input-block">
                    <input type="text" name="bank_account" placeholder="请填写银行账号" autocomplete="off" class="layui-input" value="<?=$model->bank_account?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">发票抬头</label>
                <div class="layui-input-block">
                    <input type="text" name="invoice_title" placeholder="请填写发票抬头" autocomplete="off" class="layui-input" value="<?=$model->invoice_title?>">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">税号</label>
                <div class="layui-input-block">
                    <input type="text" name="invoice_number" placeholder="请填写税号" autocomplete="off" class="layui-input" value="<?=$model->invoice_number?>">
                </div>
            </div>
        </div>
    </div>
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="account" lay-verify="required"  placeholder="请填写登录帐号" value="<?=$model->account?>" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label"><span style="color: #ff6d6d;margin-right: 5px;">*</span>密码</label>
                <div class="layui-input-block">
                    <input type="text" name="password"  placeholder="如果不修改密码，请留空" value="" autocomplete="off" class="layui-input">
                </div>
            </div>
        </div>
    </div>
...
<script>
    layui.config({
        ...
        form.on('submit(layuiadmin-app-form-submit)', function (data) {
            ...
            $.post({
                type: "post"
                , url: '/admin/purchase-provider/save?id=<?=$model->id?>'
                , dataType:'json'
                , data: field
                , success: function (e) {
                    console.log(e);
