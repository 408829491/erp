<form class="layui-form" style="padding: 20px 30px 0 0;">
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="name"  value="" placeholder="请输入销售姓名" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">销售账号</label>
        <div class="layui-input-block">
            <input type="text" name="account_tel"  value="" placeholder="销售帐号为手机号，不能修改" autocomplete="off" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
