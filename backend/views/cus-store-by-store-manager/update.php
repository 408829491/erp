...
<div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 20px 30px 0 0;">
    ...
    <div style="display: flex;justify-content: flex-end;margin-bottom: 10px">
        <button class="layui-btn layui-btn-normal" lay-submit lay-filter="update-submit">修改</button>
    </div>
</div>
...
<script>
    layui.config({
        ...
        form.on('submit(update-submit)', function(data){
            ...
            admin.req({
                type: "post"
                , url: layui.setter.reqUrlBase + '/admin/cus-store-by-store-manager/edit'
                , dataType: "json"
                , cache: false
                , data: field
                , done: function () {
