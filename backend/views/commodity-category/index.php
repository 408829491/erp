        ...
        var $ = layui.$, active = {
            batchdel: function () {
                ...
                layer.confirm('确定删除吗？', function (index) {
                    ...
                    admin.req({
                        type: "post"
                        , url: '/admin/commodity-category/delete'
                        , dataType: "json"
                        , cache: false
                        , data: field
                        , done: function () {
            ...
            add: function () {
                var index=layer.open({
                    type: 2
                    , title: '添加'
                    , content: '/admin/commodity-category/create?pid=0'
                    , maxmin: true
                    , area: ['500px', '250px']
                    , btn: ['确定', '取消']
        ...
        var renderTable = function () {
            ...
            treetable.render({
                ...
                cols: [[
                    ...
                    , {field: 'sequence', width: 100, title: '顺序'}
        ...
        table.on('tool(list)', function (obj) {
            ...
            if (obj.event === 'subAdd') {
                layer.open({
                    type: 2
                    , title: '添加'
                    , content: '/admin/commodity-category/create?pid=' + data.id
                    , maxmin: true
                    , area: ['500px', '250px']
                    , btn: ['确定', '取消']
                    , yes: function (index, layero) {
                ...
                layer.open({
                    type: 2
                    , title: '编辑'
                    , content: '/admin/commodity-category/update?id=' + data.id
                    , maxmin: true
                    , area: ['500px', '250px']
                    , btn: ['确定', '取消']
                    , yes: function (index, layero) {
                        ...
                        iframeWindow.layui.form.on('submit(layuiadmin-app-form-edit)', function (data1) {
                            ...
                            admin.req({
                                type: "post"
                                , url: '/admin/commodity-category/edit'
                                , dataType: "json"
                                , cache: false
                                , data: field
                                , done: function () {
