<div class="layui-card">
    <div class="layui-form layui-card-header layuiadmin-card-header-auto">
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <div class="layui-input-inline">
                    <input type="text" name="searchText" placeholder="请输入商品名称" autocomplete="off" class="layui-input">
                </div>
            </div>
            <div class="layui-inline">
                <div class="layui-input-inline">
    ...
    layui.config({
        ...
        table.on('tool(list)', function (obj) {
            ...
            if (obj.event === 'view') {
                ...
                layer.open({
                    type: 2
                    , title: [data.commodity_name + ' 分拣情况', 'font-size: 14px;font-weight: 700;']
                    , content: '/admin/sort/sort-rate-view?commodityId=' + data.commodity_id + '&is_basics_unit=' + data.is_basics_unit + '&unit=' + data.unit + '&base_self_ratio=' + data.base_self_ratio + '&delivery_date=' + selectDate
                    , maxmin: true
                    , area: ['80%', '80%']
                    , btn: ['关闭']
                });
