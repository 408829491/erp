<link rel="stylesheet" media="screen and (min-device-width: 1920px)" href="/admin/resources/css/fullScreenSortByUserDetailWidth1920.css">
<link rel="stylesheet" media="screen and (max-device-width: 1366px)" href="/admin/resources/css/fullScreenSortByUserDetailWidth1366.css">
            ...
            <?php foreach ($data as $index=>$item) : ?>
                <div class="body_div_div4_div_div">
                    <div class="body_div_div4_div_div_div1 <?php if ( $item['is_sorted'] == 1 ) : ?>body_div_div4_div_div_div1_sorted<?php endif; ?> <?php if ( $index == 0 ) : ?><?php if ( $item['is_sorted'] == 1 ) : ?>body_div_div4_div_div_div1_activity2<?php else : ?>body_div_div4_div_div_div1_activity<?php endif; ?><?php endif; ?>">
                        <div class="body_div_div4_div_div_div1_text"><?= $item['commodity_name'] ?></div>
...
<script>
    layui.config({
        ...
        $('.body_div_div_div4').on('click', function () {
            ...
            admin.req({
                type: "post"
                , url: '/admin/sort/find-sort-num-all-by-date-and-user-id'
                , dataType: "json"
                , data: {
                    userId: userId,
                    date: date
                ...
                , done: function (res) {
                    if (res.data.totalNum == 0) {
                        ...
                        layer.confirm('一共有' + res.data.totalNum + '个商品未分拣，是否全部分拣？', {icon: 3, title:'提示'}, function (index) {
                            admin.req({
                                type: "post"
                                , url: '/admin/sort/sort-by-date-and-user-id'
                                , dataType: "json"
                                , cache: false
                                , data: {
                                    userId: userId,
