    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline" style="width: 350px">
            <div style="width: 300px;display: flex;">
                <input type="text" name="activityTime" lay-verify="required" class="layui-input" id="activityTime" readonly value="<?= $model->start_time ?> 到 <?= $model->end_time ?>">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    layui.config({
        ...
        form.on('submit(layuiadmin-app-form-submit)', function (data) {
            ...
            admin.req({
                type: "post"
                , url: '/admin/cus-seckill-commodity-by-store-manager/edit'
                , dataType: "json"
                , cache: false
                , data: field
                , done: function () {
