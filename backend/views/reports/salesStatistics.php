    ...
    <div class="layui-row layui-col-space15">
        <div class="layui-col-sm2 layui-col-md2">
            <div class="layui-card">
                ...
                <div class="layui-card-body layuiadmin-card-list">
                    <p class="layuiadmin-big-font" id="salesman">0</p>
                </div>
            </div>
        </div>
        <div class="layui-col-sm2 layui-col-md2">
        ...
        <div class="layui-col-sm2 layui-col-md2">
            <div class="layui-card">
                ...
                <div class="layui-card-body layuiadmin-card-list">
                    <p class="layuiadmin-big-font" id="refund_price">0</p>
                </div>
            </div>
        </div>
        <div class="layui-col-sm2 layui-col-md2">
        ...
        <div class="layui-col-sm12 layui-col-md12">
            <div class="layui-card">
                <div class="layui-card-body">
                    <div style="width: 100%; height: 400px;" id="users">
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    layui.config({
        ...
        table.render({
            elem: '#list'
            , url: '/admin/reports/get-sales-statistics'
            , toolbar: true
            , title: '用户数据表'
            , cols: [[
                {field: 'id', title: '序号', width: 80, fixed: 'left', unresize: true, sort: true, totalRowText: '合计:'}
                , {field: 'salesman_name', title: '业务员'}
                , {field: 'users_count', title: '客户数'}
                , {field: 'total_count', title: '订单笔数'}
                , {field: 'total_refund_count', title: '退货笔数'}
                , {field: 'total_price', title: '订货金额'}
                , {field: 'total_refund_count', title: '退货金额'}
                , {field: 'summary', title: '金额小计'}
                , {field: 'rank', title: '综合排名'}
            ]]
            , totalRow: true
            , page: false
            , done: function (obj) {
                // 基于准备好的dom，初始化echarts实例
                $('#salesman').text(obj.salesman);
                ...
                for (var i = 0; i < data.length; i++) {
                    legend[i] = data[i]['salesman_name'];
                    series[i] = {"name":data[i]['salesman_name'],"value":data[i]['total_price']}
                }
