            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="order-list-barDemo">
                        <a class="layui-btn layui-btn-xs" lay-event="detail">查看下单历史</a>
                    </script>
                </div>
            </div>
        </div>
    ...
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'create_time', title:'最后下单时间', sort: true}
                ,{field:'count', title:'下单次数',sort: true}
                ,{field:'money', title:'下单金额', sort: true}
                ,{field:'pay_money', title:'发货金额',sort: true}
