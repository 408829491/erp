                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="nickname" id="nickname" placeholder="输入客户名称/订单号/手机号"
                                   autocomplete="off" class="layui-input" style="width:210px" lay-verify="required">
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name='delivery_date' class="layui-input" id="test-laydate-range-date"
                                   placeholder="请选择发货日期" lay-verify="required">
                        </div>
                    </div>
                    <div class="layui-inline">
        ...
        layui.config({
            ...
            var action = {
                ...
                addProductList: function () {
                    ...
                    if (!user_id) {
                        layer.alert('请选择客户', {'icon': 5});
                        return false;
                    }
                    var create_window = layer.open({
                        id: 'main',
                        type: 2,
                        content: '/admin/commodity-list/list?user_id=' + user_id,
                        area: ['1000px', '630px'],
                        title: '请选择商品',
                        maxmin: false,
