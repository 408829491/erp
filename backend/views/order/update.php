<div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 15px">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="nickname" lay-verify="required"  id="nickname" placeholder="输入客户名称/订单号/手机号" autocomplete="off" class="layui-input" style="width:210px" value="<?=$nick_name ?>">
                        </div>
                    </div>
                    <div class="layui-inline">
                        <label class="layui-form-label">发货日期</label>
                        <div class="layui-input-inline">
                            <input type="text" name='delivery_date' class="layui-input" lay-verify="required"  id="test-laydate-range-date" placeholder="请选择发货日期"  value="<?=$delivery_date ?>">
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="delivery_time_detail">
                                <option value="06:00-07:00" <?php if ($delivery_time_detail == '06:00-07:00') : ?>selected<?php endif; ?>>06:00-07:00</option>
                                <option value="07:00-08:00" <?php if ($delivery_time_detail == '07:00-08:00') : ?>selected<?php endif; ?>>07:00-08:00</option>
                            </select>
                        </div>
                    </div>
                </div>
    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            <div id="user-info">收货人：<?=$nick_name ?>  <?=$user_name ?>  <?=$address_detail?></div>
        </div>
    </div>
    <div class="layui-card">
        ...
        <div class="layui-card">
            <div class="layui-card-body">
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="remark" id="remark" placeholder="输入订单备注" autocomplete="off" class="layui-input" style="width:850px" value="<?=$remark ?>">
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        layui.config({
            ...
            table.render({
                elem: '#subList'
                ,cols: [[ //标题栏
                    {field:'commodity_id', title:'ID', width:80, fixed: 'left', unresize: true, sort: true, totalRowText: '合计:'}
