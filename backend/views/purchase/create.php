            ...
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name='plan_date' class="layui-input" id="test-laydate-range-date" placeholder="请选择发货日期" lay-verify="required" >
                    </div>
                </div>
            </div>
         </div>
    ...
    <div class="layui-card">
        <div class="layui-card-body">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="remark" id="remark" placeholder="请输入备注" autocomplete="off" class="layui-input" style="width:850px">
                </div>
            </div>
        </div>
    </div>
...
<script type="text/html" id="total_priceTpl">
    <input type="text" name="total_price" placeholder="" autocomplete="off" class="layui-input order_c" id="total_price" lay-filter="total_price" style="height: 28px" value="{{d.total_price}}">
</script>
    ...
    layui.config({
        ...
        table.render({
            ...
            ,cols: [[ //标题栏
                ...
                ,{field: 'purchase_price', title: '采购价',width: 120,templet: '#purchase_priceTpl', unresize: true,edit: 'text',event: 'purchase_price'}
                ,{field: 'purchase_num', title: '待采购量',width: 120,templet: '#purchase_numTpl', unresize: true,edit: 'text',event: 'purchase_num'}
                ,{field: 'total_price', title: '采购金额（元）',width: 140, unresize: true}
        ...
        var action = {
            ...
            addProductSingle: function(){
                ...
                table_name.purchase_price =  table_name.price;
                table_name.purchase_num =  table_name.num;
                table_name.total_price = toDecimal2(table_name.purchase_price * table_name.purchase_num );
                table.reload('subList', {
