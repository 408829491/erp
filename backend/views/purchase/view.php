    ...
    <div class="layui-card">
        <div class="layui-card-header">基本信息
            <div style="float:right">
                <button style="background-color: #77CF20" class="layui-btn layui-btn-sm layui-btn-normal" id="share" data-type="exports">导出</button> <button style="background-color: #77CF20" class="layui-btn layui-btn-sm layui-btn-normal" id="share" data-type="share">分享采购单</button>
            </div>
        </div>
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" name='plan_date' class="layui-input" id="test-laydate-range-date"
                                       placeholder="请选择发货日期" value="<?= $plan_date ?>" disabled>
                            </div>
                        </div>
        ...
        <div class="layui-card">
            ...
            <div class="layui-card-body">
                ...
                <script type="text/html" id="purchase_priceTpl">
                    <input type="text" name="purchase_price" placeholder="" autocomplete="off"
                           class="layui-input order_c" id="purchase_price" lay-filter="purchase_price"
                           style="height: 28px" value="{{d.purchase_price}}">
                </script>
                        ...
                        var action = {
                            share: function () {
                                layer.open({
                                    id: 'main',
                                    type: 2,
                                    content: '/admin/purchase/share-purchase?id=' + <?=$id?>,
                                    area: ['500px', '480px'],
                                    title: '分享采购单',
                                    maxmin: false,
                                    btn: ['关闭']
                            ...
                            exports: function () {
                                //导出采购单
                                document.location.href = '/admin/purchase/export-purchase?id=<?=$id?>';
                            }
                        };
