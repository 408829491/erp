    ...
    <div class="layui-card">
        ...
        <div class="layui-card-body">
            ...
            <script type="text/html" id="operation">
                <!--<a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="view" style="background-color: #77CF20"><i class="layui-icon layui-icon-edit"></i>详情</a>-->
...
<script>
    layui.config({
        ...
        var $ = layui.$, active = {
            batchdel: function () {
                ...
                layer.confirm('确定删除吗？', function (index) {
                    ...
                    admin.req({
                        type: "post"
                        , url: '/admin/cus-seckill-commodity/delete'
                        , dataType: "json"
                        , cache: false
                        , data: field
                        , done: function () {
            ...
            add: function () {
                var index=layer.open({
                    type: 2
                    , title: '添加'
                    , content: '/admin/cus-seckill-commodity/create'
                    , maxmin: true
                    , area: ['600px', '300px']
                    , btn: ['确定', '取消']
        ...
        table.render({
            elem: '#list'
            , url: '/admin/cus-seckill-commodity/index-data'
            , cols: [[
                {type: 'checkbox', fixed: 'left', minWidth: 100}
                , {field: 'id', width: 100, title: 'ID', sort: true}
                , {field: 'name', title: '活动名称', minWidth: 100}
                , {title: '抢购活动时间', minWidth: 100, templet: '#activityTime'}
                , {field: 'seckill_commoditys_name', title: '抢购商品', minWidth: 100}
        ...
        table.on('tool(list)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                var index = layer.open({
                    type: 2
                    , title: '编辑'
                    , content: '/admin/cus-seckill-commodity/update?id=' + data.id
                    , maxmin: true
                    , area: ['500px', '250px']
                    , btn: ['确定', '取消']
                    , yes: function (index, layero) {
                ...
                admin.req({
                    type: "post"
                    , url: '/admin/cus-seckill-commodity/close'
                    , dataType: "json"
                    , cache: false
                    , data: {
                        id: data.id
