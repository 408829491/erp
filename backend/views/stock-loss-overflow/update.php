        ...
        layui.config({
            ...
            table.render({
                ...
                ,cols: [[ //标题栏
                    ...
                    ,{field: 'num', title: '数量',width: 120,templet: '#test-table-countTpl', unresize: true,edit: 'text',event: 'setCount'}
                    ,{field: 'price', title: '成本价（元）', width: 150}
            ...
            var action = {
                ...
                audit: function () {
                    layer.confirm('请确认是否审核该单据', {icon: 3, title:'提示'}, function(index){
                        //审核
                        var index = parent.layer.getFrameIndex(window.name);
                        admin.req({
                            type: "post"
                            , url: '/admin/stock-loss-overflow/check?id=<?=$id?>'
                            , dataType: "json"
                            , cache: false
                            , done: function (d) {
                                if(d.code === '200'){
