<div class="layui-form" lay-filter="layuiadmin-app-form-list" id="layuiadmin-app-form-list" style="padding: 15px">
    <div class="layui-card">
            ...
            <div class="layui-card-header layuiadmin-card-header-auto">
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <select name="type">
                                <option value="1">手动报损</option>
                                <option value="2">手动报溢</option>
                            </select>
                        </div>
                    </div>
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="operator" id="operator" autocomplete="off"
                                   ...
                                   style="width:210px" lay-verify="required">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="layui-card">
            <div class="layui-card-header">损溢单商品清单</div>
            <div class="layui-card-body">
                <div class="layui-inline">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline">
                        <button class="layui-btn layui-input-inline" id="product-add-list" data-type="addProductSingle">
                            添加
                        </button>
                    </div>
                </div>
            ...
            <div class="layui-card">
                <div class="layui-card-body">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="remark" id="remark" placeholder="输入备注" autocomplete="off"
    ...
    <script type="text/html" id="test-table-countTpl">
        <input type="text" name="order_count" placeholder="" autocomplete="off" class="layui-input order_c"
               id="order_count"
               lay-filter="order_count" style="height: 28px" value="{{d.num}}">
    </script>
        ...
        layui.config({
            ...
            table.render({
                ...
                , cols: [[ //标题栏
                    ...
                    , {field: 'price', title: '成本价', width: 150}
                    , {field: 'total_price', title: '报损报溢金额', width: 190, totalRow: true}
                    , {
                        field: 'remark',
                        title: '备注',
                        width: 180,
            ...
            form.on('submit(layuiadmin-app-form-submit)', function (data) {
                ...
                admin.req({
                    type: "post"
                    , url: '/admin/stock-loss-overflow/save'
                    , dataType: "json"
                    , cache: false
                    , data: field
                    , done: function () {
